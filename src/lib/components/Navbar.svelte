...
<nav class="fixed top-0 left-0 right-0 z-50 {navbarBg} backdrop-blur-sm py-3 md:py-4 border-b-[1px] {borderColor} transition-colors duration-300 ease-in-out">
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<div class="flex items-center justify-between">
			...
			>
				...
				<span class="w-6 h-0.5 bg-white transition-all duration-300 {isMenuOpen ? 'opacity-0' : 'opacity-100'}"></span>
				<span class="w-6 h-0.5 bg-white transition-all duration-300 {isMenuOpen ? '-rotate-45 -translate-y-2' : ''}"></span>
			</button>
		</div>
		...
		<div class="lg:hidden overflow-hidden transition-all duration-300 ease-in-out {isMenuOpen ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'}">
			<div class="flex flex-col gap-2 py-4 mt-4 border-t {isDarkMode ? 'border-white/20' : 'border-white/10'} transition-colors duration-300">
				<a href="/" class="{textColor} py-2.5 px-2 hover:text-orange-500 {isDarkMode ? 'hover:bg-white/10' : 'hover:bg-white/5'} rounded-lg transition-all font-family-sans">Home</a>
				<a href="/tentang-kami" class="{textColor} py-2.5 px-2 hover:text-orange-500 {isDarkMode ? 'hover:bg-white/10' : 'hover:bg-white/5'} rounded-lg transition-all font-family-sans">Tentang Kami</a>
				<a href="/layanan" class="{textColor} py-2.5 px-2 hover:text-orange-500 {isDarkMode ? 'hover:bg-white/10' : 'hover:bg-white/5'} rounded-lg transition-all font-family-sans">Layanan</a>
				<a href="/portofolio" class="{textColor} py-2.5 px-2 hover:text-orange-500 {isDarkMode ? 'hover:bg-white/10' : 'hover:bg-white/5'} rounded-lg transition-all font-family-sans">Portofolio</a>
				<a href="/teknologi" class="{textColor} py-2.5 px-2 hover:text-orange-500 {isDarkMode ? 'hover:bg-white/10' : 'hover:bg-white/5'} rounded-lg transition-all font-family-sans">Teknologi</a>
